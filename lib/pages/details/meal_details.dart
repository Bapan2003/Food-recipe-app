...
class MealDetailsPageScreen extends StatefulWidget {
  ...
  const MealDetailsPageScreen({super.key});
...
class _MealDetailsPageScreenState extends State<MealDetailsPageScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_){
      context.read<MealDetailsBloc>().add(GetMealDetails(id: 52772));
    });
  }
              ...
              background: _appBarBackGround(size),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                        backgroundColor: whiteColor,
                        child: Icon(false?Icons.favorite_border_outlined:Icons.favorite,color: redColor,))
                  ],
                ),
              )),
            ),
